...
![Screenshot showing Wireshark filter and identified source/destination IPs](screenshots/01_sender_receiver_ip.png)
...
![Screenshot of Wireshark's TCP Stream graph/statistics showing the duration](screenshots/06_upload_duration.png)
